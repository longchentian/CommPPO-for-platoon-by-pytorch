...
class PPO_continuous():
    ...
    def load_model(self, pth1, pth2):
        actor_data = torch.load(pth1)
        critic_data = torch.load(pth2)
        self.actor.load_state_dict(actor_data)
        self.critic.load_state_dict(critic_data)
